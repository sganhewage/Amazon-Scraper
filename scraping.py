...
def scraping() -> None:
    ...
    # driver.implicitly_wait(5)
    # captchaImageLink = driver.find_element(By.XPATH, "//div[@class = 'a-section a-text-center cvf-captcha-img']//img").get_attribute('src')
    ...
    # driver.implicitly_wait(5)
    # elem = driver.find_element(By.ID, "time-filter_2")
    # elem.click()
